#ifndef POLIMIDL_LAYERS_INTERNAL_BIAS_HPP
#define POLIMIDL_LAYERS_INTERNAL_BIAS_HPP
...
class bias : public layer<type_t, components, true> {
 public:
  bias(const type_t* bias) : bias_(bias), batch_size_(1) {}
